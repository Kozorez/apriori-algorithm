...
class UnitTest(unittest.TestCase):
    ...
    def testGenerateAssociationRulesFromItemsets9(self):
        dataset = {
            "T100": ["I1", "I2", "I5"],
            "T200": ["I2", "I4"],
            "T300": ["I2", "I3"],
        ...
        associationRules = association.generateAssociationRulesFromItemsets(
            dataset, frequentItemsets, 70)
    ...
    def testGenerateAssociationRulesFromItemsets0(self):
        dataset = {}
    ...
    def testGenerateAssociationRulesFromItemsets2(self):
        dataset = {
            "T100": ["I2", "I3"],
            "T200": ["I2", "I3"]
        }
    ...
    def testGenerateAssociationRulesFromDataset9(self):
        ...
        self.assertEqual(association.generateAssociationRulesFromDataset(
                         dataset, 2, 70),
                         {(('I1', 'I5'), ('I2',)): 1.0,
                          (('I2', 'I5'), ('I1',)): 1.0,
                          (('I5',), ('I1', 'I2')): 1.0})
